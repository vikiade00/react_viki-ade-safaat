  ...
  const TABLE_COLUMNS = [
    {
      ...
      key: "productCode",
      render: (text, record) => <Link to={`/create-product/${record.productCode}`}>{text}</Link>,
    },
    {
      title: "Product Name",
      ...
      >
        <Form.Item
          ...
          rules={[
            ...
            { pattern: /^[a-zA-Z0-9 -]{3,50}$/, message: "Product name harus terdiri dari 3-50 characters dan tidak boleh mengandung simbol" },
          ]}
        >
        ...
        <Form.Item label="Additional Description" rules={[{ required: true, message: "Additional Description tidak boleh kosong" }]}>
        ...
        <Form.Item
          ...
          rules={[
            ...
            { pattern: /^[1-9]\d{0,10}$/, message: "Product price dapat diisi antara 1-99999999999" },
          ]}
        >
