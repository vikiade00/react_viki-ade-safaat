    ...
    <div className="container-center">
      <Card bodyStyle={{ width: "400px" }}>
        ...
        <div className="radio-grup-register-login">
          <Radio.Group defaultValue="Login" buttonStyle="solid" onChange={onChange} value={section}>
            <Radio.Button value="Login">Login Here</Radio.Button>
            <Radio.Button value="Register">Register Here</Radio.Button>
          </Radio.Group>
        </div>

        <Form className="form-login" form={form} onFinish={section === "Login" ? onLogin : onRegister}>
